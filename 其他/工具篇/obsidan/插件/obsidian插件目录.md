...
| 插件名称                                   | 中文      | 用途                                                                         |
| -------------------------------------- | ------- | -------------------------------------------------------------------------- |
| [[其他/工具篇/obsidan/插件/Activity History]]                   | 活动历史记录  | Github 喜欢活动块来跟踪整个笔记库或指定项目的活动。                                              |
| [[其他/工具篇/obsidan/插件/Admonition]]                         | 警告      | 用来添加警告块样式块                                                                 |
| [[其他/工具篇/obsidan/插件/advanced random note]]               | 高级随机笔记  | 从自定义查询创建命令以打开随机笔记。                                                         |
| [[其他/工具篇/obsidan/插件/Annotator]]                          |         | 这是 Obsidian 的一个示例插件。它允许您打开和注释 PDF 和 EPUB 文件。                               |
| Canvas Mindmap                         |         | 一个让你的画布像思维导图一样工作的插件。                                                       |
| [[其他/工具篇/obsidan/插件/Clear Unused Images]]                |         | 清除你不再使用的图片在你的 markdown 注释中，以节省空间。                                          |
...
| [[其他/工具篇/obsidan/插件/folder index]]                       | 文件夹索引   | - 自动生成索引文件                                                                 |
...
| translate                              |         | 翻译插件                                                                       |
| QuickAdd                               |         |                                                                            |
| [[其他/工具篇/obsidan/插件/vocabulary view]]                    | 词汇视图    | 您可以使用它写下一些单词及其解释，并以词汇测试风格预览它们。                                             |
...
| [[其他/工具篇/obsidan/插件/Metadata Menu]]                      |         | 为数据管理爱好者而开发的插件：可用来编辑和管理笔记的元数据。                                             |
| [[其他/工具篇/obsidan/插件/folder index]]                       | 文件夹索引   | - 自动生成索引文件                                                                 |
