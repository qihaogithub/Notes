...
通过元素轮廓的线稿和色块来控制图像
[[AI/2·stable diffusion/Canny 硬边缘]]
[[AI/2·stable diffusion/MLSD 直线]]
[[AI/2·stable diffusion/Lineart 线稿]]
[[AI/2·stable diffusion/SoftEdge 软边缘]]
[[Scribble-Sketch 涂鸦-草图]]
[[AI/2·stable diffusion/Segmentation 语义分割]]
### 景深类
通过画面中物体的前后景深关系来控制图像
![image.png](https://qhdtc.oss-cn-chengdu.aliyuncs.com/obsidian/20230928144008.png)

[[AI/2·stable diffusion/Depth 深度]]
[[AI/2·stable diffusion/NormalMap 法线贴图]]
### 对象类
通过人物的骨架特征或面部轮廓来控制图像
![image.png](https://qhdtc.oss-cn-chengdu.aliyuncs.com/obsidian/20230928144110.png)

[[AI/2·stable diffusion/OpenPose 姿态]]
### 重绘类
通过原图参考来绘制，没有可视化的特征提取，类似图生图
![image.png](https://qhdtc.oss-cn-chengdu.aliyuncs.com/obsidian/20230928144232.png)

[[AI/2·stable diffusion/Inpaint 局部重绘]]
[[AI/2·stable diffusion/Tile 分块]]
[[AI/2·stable diffusion/InstructP2P 指导图生图]]
[[AI/2·stable diffusion/Shuffle 随机洗牌]]
## 社区模型
社区模型的使用频率并不高，很多效果也是对现有功能的优化或调整，大致了解其功能即可，如果有特定需求可以下载对应模型进行尝试，其中有些已经支持配合 SDXL 使用。

[[AI/2·stable diffusion/Reference 参考]]
[[AI/2·stable diffusion/Recolor 重新上色]]
[[AI/2·stable diffusion/T2I-Adapter 文生图适配器]]
[[AI/2·stable diffusion/IP-Adapter 图生图适配器]]
## 应用场景
[[AI/2·stable diffusion/一键换背景]] · [[AI/2·stable diffusion/人物与背景融合]] · [[AI/2·stable diffusion/控制图片光源]] · [[AI/2·stable diffusion/变更风格]] · [[AI/2·stable diffusion/手势控制]] · [[AI/2·stable diffusion/局部重绘图片融合]] · [[AI/2·stable diffusion/三视图]] · [[AI/2·stable diffusion/生成手绘图]]
