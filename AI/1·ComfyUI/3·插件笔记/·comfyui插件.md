## 3 D
[[AI/1·ComfyUI/3·插件笔记/ComfyUI-3D-Pack]]

## 提示词
[[DynamicPrompts·动态提示词]]     [[AI/1·ComfyUI/3·插件笔记/一键生成提示词 ·OneButtonPrompt]]   [[AI/1·ComfyUI/3·插件笔记/ComfyUI-VisualQueryTemplate：模板化图像反推提示词]]    [[AI/1·ComfyUI/3·插件笔记/ComfyUI Prompt Gallery提示词管理]]  [[AI/1·ComfyUI/3·插件笔记/自然语言提示词反推]]
## 效率
[[AI/1·ComfyUI/3·插件笔记/ComfyUI-NodeAligner·节点布局整理插件]]
[[AI/1·ComfyUI/3·插件笔记/辣椒酱的界面汉化]] 
 [[AI/1·ComfyUI/3·插件笔记/AIGODLIKE-ComfyUl-Studio · 模型缩略图]] 
## 其他
[[AI/1·ComfyUI/3·插件笔记/seamless-tiling·无缝贴图]]
[[AI/1·ComfyUI/3·插件笔记/MingNodes·仿像素蛋糕追色]]

## ControlNet
[[AI/1·ComfyUI/3·插件笔记/AnimeLineArt 动漫艺术线预处理器]]     [[AI/1·ComfyUI/3·插件笔记/Aux 集成预处理器]] [[AI/1·ComfyUI/3·插件笔记/Anyline]]      [[AI/1·ComfyUI/3·插件笔记/Binary二值化预处理器]]     [[AI/1·ComfyUI/3·插件笔记/Canny 细致线预处理器]]     

## 图片处理
 [[AI/1·ComfyUI/3·插件笔记/BRIA-AI Matting抠图节点]] 

## 反推
[[AI/1·ComfyUI/3·插件笔记/JoyCaption2]]
...
## 综合插件
[[AI/1·ComfyUI/3·插件笔记/Impact Pack]]
[[AI/1·ComfyUI/3·插件笔记/TTP Toolset]]
# 未分类
   [[AI/1·ComfyUI/3·插件笔记/ComfyUI Ollama]]    [[AI/1·ComfyUI/3·插件笔记/ComfyUI Prompt Gallery提示词管理]]    [[AI/1·ComfyUI/3·插件笔记/ComfyUI-3D-Pack]]    [[AI/1·ComfyUI/3·插件笔记/ComfyUI-Custom-Scripts·瑞士军刀美化辅助]]    [[AI/1·ComfyUI/3·插件笔记/ComfyUI-IC-Light]]    [[AI/1·ComfyUI/3·插件笔记/ComfyUI-NodeAligner·节点布局整理插件]]    [[AI/1·ComfyUI/3·插件笔记/ComfyUI-VisualQueryTemplate：模板化图像反推提示词]]    [[AI/1·ComfyUI/3·插件笔记/ComfyUI-segment-anything-2]]    [[AI/1·ComfyUI/3·插件笔记/ComfyUI_FaceAnalysis]]    [[AI/1·ComfyUI/3·插件笔记/ComfyUI_FaceShaper]]    [[AI/1·ComfyUI/3·插件笔记/ComfyUI_IPAdapter_plus]]    [[AI/1·ComfyUI/3·插件笔记/ComfyUI_InstantID]]    [[AI/1·ComfyUI/3·插件笔记/ComfyUI_essentials]]    [[AI/1·ComfyUI/3·插件笔记/DepthAnythingV2]]    [[AI/1·ComfyUI/3·插件笔记/Diffusion Edge]]    [[Easy Slider Control ]]    [[AI/1·ComfyUI/3·插件笔记/Easy Use]]    [[AI/1·ComfyUI/3·插件笔记/FakeScribble 伪涂鸦预处理器]]    [[AI/1·ComfyUI/3·插件笔记/HED模糊线预处理器]]    [[AI/1·ComfyUI/3·插件笔记/IC-Light-Native]]    [[AI/1·ComfyUI/3·插件笔记/Ic light]]    [[AI/1·ComfyUI/3·插件笔记/Image Color Match   图像颜色匹配]]    [[AI/1·ComfyUI/3·插件笔记/Image Detail Transfer]]    [[AI/1·ComfyUI/3·插件笔记/Image To Prompt]]    [[AI/1·ComfyUI/3·插件笔记/ImageResize+]]    [[AI/1·ComfyUI/3·插件笔记/InstantID]]    [[AI/1·ComfyUI/3·插件笔记/K采样器-调度器]]    [[AI/1·ComfyUI/3·插件笔记/K采样器-采样器]]    [[AI/1·ComfyUI/3·插件笔记/K采样器]]    [[AI/1·ComfyUI/3·插件笔记/LLMs]]    [[AI/1·ComfyUI/3·插件笔记/LineArt 艺术线预处理器]]    [[AI/1·ComfyUI/3·插件笔记/LineArtStandard 艺术线预处理器]]    [[AI/1·ComfyUI/3·插件笔记/LongClip Flux]]    [[AI/1·ComfyUI/3·插件笔记/M-LSD 线段预处理器]]    [[AI/1·ComfyUI/3·插件笔记/Manager]]    [[AI/1·ComfyUI/3·插件笔记/MangaAnime 漫画艺术线预处理器]]    [[AI/1·ComfyUI/3·插件笔记/MingNodes·仿像素蛋糕追色]]    [[AI/1·ComfyUI/3·插件笔记/PidiNet 模糊线预处理器]]    [[AI/1·ComfyUI/3·插件笔记/PuLID_ComfyUI]]    [[AI/1·ComfyUI/3·插件笔记/Scribble 涂鸦预处理器]]    [[AI/1·ComfyUI/3·插件笔记/ScribbleXDoG 涂鸦预处理器]]    [[AI/1·ComfyUI/3·插件笔记/TEEDPreprocessor]]    [[AI/1·ComfyUI/3·插件笔记/UltimateSDUpscale]]    [[AI/1·ComfyUI/3·插件笔记/Workspace Manager]]    [[AI/1·ComfyUI/3·插件笔记/comfyui-GGUF]]    [[AI/1·ComfyUI/3·插件笔记/comfyui-browser]]    [[AI/1·ComfyUI/3·插件笔记/comfyui-nodes-docs]]    [[AI/1·ComfyUI/3·插件笔记/comfyui-sixgod_prompt]]    [[AI/1·ComfyUI/3·插件笔记/comfyui-various]]    [[AI/1·ComfyUI/3·插件笔记/comfyui_controlnet_aux]]    [[AI/1·ComfyUI/3·插件笔记/controlnet++]]    [[AI/1·ComfyUI/3·插件笔记/ergouz kaiguan]]    [[AI/1·ComfyUI/3·插件笔记/seamless-tiling·无缝贴图]]    [[AI/1·ComfyUI/3·插件笔记/sixgod_prompt]]    [[AI/1·ComfyUI/3·插件笔记/x-flux-comfyui]]    [[AI/1·ComfyUI/3·插件笔记/·comfyui插件]]    [[AI/1·ComfyUI/3·插件笔记/一键生成提示词 ·OneButtonPrompt]]    [[AI/1·ComfyUI/3·插件笔记/安装节点]]    [[AI/1·ComfyUI/3·插件笔记/自然语言提示词反推]]    [[AI/1·ComfyUI/3·插件笔记/辣椒酱的界面汉化]]
...
11. **ComfyUI-Advanced-ControlNet**：这个插件提供了对ControlNet的高级支持，允许用户控制哪些潜在变量应受到ControlNet输入的影响。这对于生成具有特定风格或特征的图像至关重要。
