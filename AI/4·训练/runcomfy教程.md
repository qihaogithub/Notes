...
[runcomfy教程](AI/4·训练/runcomfy教程.md#comfyui-flux-lora-训练教程)ComfyUI FLUX LoRA 训练教程
-------------------------------------------------
...
[runcomfy教程](AI/4·训练/runcomfy教程.md#1-准备您的-flux-lora-训练数据集)1\. 准备您的 FLUX LoRA 训练数据集
---------------------------------------------------
...
### [runcomfy教程](AI/4·训练/runcomfy教程.md#获取训练数据的过程)获取训练数据的过程

![](https://cdn.runcomfy.com/workflow_assets/1123/readme01.webp)

### [runcomfy教程](AI/4·训练/runcomfy教程.md#训练数据示例)训练数据示例

![](https://cdn.runcomfy.com/workflow_assets/1123/readme02.webp)

您也可以根据您的具体需求收集自己的数据集——FLUX LoRA 训练具有灵活性，并且适用于各种类型的数据。

[runcomfy教程](AI/4·训练/runcomfy教程.md#2-flux-lora-训练过程)2\. FLUX LoRA 训练过程
---------------------------------------

FLUX LoRA 训练工作流程包括多个关键节点，这些节点协同工作以训练和验证您的模型。以下是主要节点的详细概述，分为三个部分：数据集、设置与初始化、训练。

### [runcomfy教程](AI/4·训练/runcomfy教程.md#21-设置-flux-lora-训练的数据集)2.1. 设置 FLUX LoRA 训练的数据集

数据集部分包含两个基本节点，帮助您配置和自定义您的训练数据：**TrainDatasetGeneralConfig** 和 **TrainDatasetAdd**。

### [runcomfy教程](AI/4·训练/runcomfy教程.md#211-traindatasetgeneralconfig)2.1.1. TrainDatasetGeneralConfig
...
### [runcomfy教程](AI/4·训练/runcomfy教程.md#212-traindatasetadd)2.1.2. TrainDatasetAdd

![](https://cdn.runcomfy.com/workflow_assets/1123/readme04.webp)

**TrainDatasetAdd** 节点是您指定每个要包含在 FLUX LoRA 训练中的单个数据集详细信息的地方。

#### [runcomfy教程](AI/4·训练/runcomfy教程.md#输入目录训练数据集路径)输入目录：训练数据集路径
...
#### [runcomfy教程](AI/4·训练/runcomfy教程.md#类别标记)类别标记
...
#### [runcomfy教程](AI/4·训练/runcomfy教程.md#设置分辨率宽度和高度批量大小)设置分辨率（宽度和高度）、批量大小
...
#### [runcomfy教程](AI/4·训练/runcomfy教程.md#多个数据集)多个数据集
...
#### [runcomfy教程](AI/4·训练/runcomfy教程.md#示例)示例
...
### [runcomfy教程](AI/4·训练/runcomfy教程.md#22-设置与初始化)2.2. 设置与初始化

设置与初始化部分是您配置 FLUX LoRA 训练的关键组件和参数的地方。此部分包括几个基本节点，它们共同工作以设置您的训练环境。

### [runcomfy教程](AI/4·训练/runcomfy教程.md#221-fluxtrainmodelselect)2.2.1. FluxTrainModelSelect
...
### [runcomfy教程](AI/4·训练/runcomfy教程.md#222-optimizerconfig)2.2.2. OptimizerConfig
...
### [runcomfy教程](AI/4·训练/runcomfy教程.md#223-initfluxloratraining)2.2.3. **InitFluxLoRATraining**

![](https://cdn.runcomfy.com/workflow_assets/1123/readme12.webp)

**InitFluxLoRATraining** 节点是所有关键组件汇聚以启动 FLUX LoRA 训练过程的中心枢纽。

#### [runcomfy教程](AI/4·训练/runcomfy教程.md#输出目录flux-lora-路径)输出目录：FLUX LoRA 路径
...
#### [runcomfy教程](AI/4·训练/runcomfy教程.md#网络维度和学习率)网络维度和学习率

接下来，您需要设置网络维度和学习率。网络维度决定了您的 LoRA 网络的大小和复杂性，而学习率控制了您的模型学习和适应的速度。

#### [runcomfy教程](AI/4·训练/runcomfy教程.md#最大训练步骤)最大训练步骤
...
### [runcomfy教程](AI/4·训练/runcomfy教程.md#234-fluxtrainvalidationsettings)2.3.4. FluxTrainValidationSettings
...
### [runcomfy教程](AI/4·训练/runcomfy教程.md#32-train_02train_03train_04)3.2. Train\_02、Train\_03、Train\_04
...
#### [runcomfy教程](AI/4·训练/runcomfy教程.md#示例-1)示例
...
[runcomfy教程](AI/4·训练/runcomfy教程.md#4-如何以及在哪里使用-flux-和-flux-lora-模型)4\. 如何以及在哪里使用 FLUX 和 FLUX LoRA 模型
---------------------------------------------------------------------
