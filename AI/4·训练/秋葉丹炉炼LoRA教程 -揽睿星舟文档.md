...
### 方法二：熟手推荐-自定义创建：启动三步走，自主操控 [#](AI/4·训练/秋葉丹炉炼LoRA教程%20-揽睿星舟文档.md#方法二熟手推荐-自定义创建启动三步走自主操控)
...
#### 二、开启工作空间 [#](AI/4·训练/秋葉丹炉炼LoRA教程%20-揽睿星舟文档.md#二开启工作空间)

点击创建后，一般1-2分钟可启动成功，待实例状态由启动中变为运行中后，点击进入vscode

![](https://doc-rde.lanrui-ai.com/assets/trainer9.png)

#### 三、启动sd-trainer [#](AI/4·训练/秋葉丹炉炼LoRA教程%20-揽睿星舟文档.md#三启动sd-trainer)
...
第二步 开始训练 [#](AI/4·训练/秋葉丹炉炼LoRA教程%20-揽睿星舟文档.md#第二步-开始训练)
-------------------------------------------------------------------------------

### 打开sd-trainer页面 [#](AI/4·训练/秋葉丹炉炼LoRA教程%20-揽睿星舟文档.md#打开sd-trainer页面)
...
### 输入路径，开始训练 [#](AI/4·训练/秋葉丹炉炼LoRA教程%20-揽睿星舟文档.md#输入路径开始训练)
...
### 查看训练进度 [#](AI/4·训练/秋葉丹炉炼LoRA教程%20-揽睿星舟文档.md#查看训练进度)
