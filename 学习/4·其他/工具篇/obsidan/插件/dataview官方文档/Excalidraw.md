...
在 Obsidian-Excalidraw 插件集成 [Excalidraw](< [Excalidraw](https://excalidraw.com/) >)，一个功能丰富的草图工具，到黑曜石。你可以在你的保险库中存储和编辑 Excalidraw 文件，你可以将图纸嵌入到你的文档中，你还可以链接到文档和其他图纸到 Excalidraw。如果想要看到 Excalidraw 的特性，请阅读我的[博客文章](https://www.zsolt.blog/2021/03/showcasing-excalidraw.html)或者观看下面的视频。
