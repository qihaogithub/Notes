...
$output_name = "flux-test-lora16G" # output model name | 模型保存名称
...
$img_attn_dim = $network_dim #img_attn层

$txt_attn_dim = $network_dim #txt_attn层

$img_mlp_dim = $network_dim #img_mlp层

$txt_mlp_dim = $network_dim   #txt_mlp层

$img_mod_dim = 0 #img_mod层

$txt_mod_dim = 0 #txt_mod层

$single_dim = $network_dim #单维度

$single_mod_dim = 0 #单维度mod

$in_dims = "$network_dim,0,0,0,$network_dim" #输入维度,对应img_in, time_in, vector_in, guidance_in, txt_in.
...
$train_single_block_indices="all" #单块训练，all为所有块，0为第一块，1为第二块，None为关闭 写法0,1,2,逗号隔开或者0-8,11-18

$train_double_block_indices="all" #双块训练，all为所有块，0为第一块，1为第二块，None为关闭 写法0,1,2,逗号隔开或者0-8,11-18
