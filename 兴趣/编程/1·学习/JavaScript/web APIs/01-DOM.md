...
![](https://qhdtc.oss-cn-chengdu.aliyuncs.com/obsidian/guide.png)
...
![](https://qhdtc.oss-cn-chengdu.aliyuncs.com/obsidian/demo.gif)
...
![](https://qhdtc.oss-cn-chengdu.aliyuncs.com/obsidian/web-api.jpg)
...
<body>
  ...
  <script>
  	...
  	const lis = document.querySelectorAll('li')  // 获取所有的li元素  
  </script>
</body>
</html>
```
